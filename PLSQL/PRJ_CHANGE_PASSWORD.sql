...
set define off;
  ...
  CREATE OR REPLACE PROCEDURE "PRJ"."PRJ_CHANGE_PASSWORD" (v_username in varchar2, v_password in varchar2, v_confirm_password in varchar2, v_out in out varchar2)
as
begin
